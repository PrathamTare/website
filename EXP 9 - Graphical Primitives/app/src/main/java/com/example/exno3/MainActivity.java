...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rectanglePaint.setColor(Color.parseColor("#FF8A80")); // Red
        rectanglePaint.setTextSize(50);

        Paint circlePaint = new Paint();
        circlePaint.setColor(Color.parseColor("#80CBC4")); // Teal
        circlePaint.setTextSize(50);

        Paint squarePaint = new Paint();
        squarePaint.setColor(Color.parseColor("#FFD180")); // Orange
        squarePaint.setTextSize(50);

        Paint linePaint = new Paint();
        linePaint.setColor(Color.parseColor("#BA68C8")); // Purple
